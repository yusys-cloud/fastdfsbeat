...
`${GOPATH}/src/github.com/yusys-cloud/fastdfsbeat`
...
```
git remote set-url origin https://github.com/yusys-cloud/fastdfsbeat
...
in the same directory with the name fastdfsbeat.
...
```
./fastdfsbeat -c fastdfsbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/yusys-cloud/fastdfsbeat
git clone https://github.com/yusys-cloud/fastdfsbeat ${GOPATH}/src/github.com/yusys-cloud/fastdfsbeat
```
